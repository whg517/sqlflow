...
export default function TicketNewPage() {
  ...
  function validate(): boolean {
    ...
    if (!changeReason.trim()) errs.changeReason = "请填写变更原因";
      ...
      errs.changeReason = "变更原因至少 10 个字符";
    setErrors(errs);
      ...
      <div className="flex-1 overflow-auto">
        <div className="mx-auto max-w-[680px] space-y-6 px-6 py-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select value={datasourceId} onValueChange={setDatasourceId}>
                <SelectTrigger
                  className={`h-9 w-full border-[var(--border-default)] bg-[var(--bg-elevated)] text-sm text-[var(--text-primary)] ${errors.datasourceId ? "border-red-500" : ""}`}
                >
          ...
          <div>
            ...
            />
            {errors.sql && (
              <p className="mt-1 text-xs text-red-400">{errors.sql}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.changeReason && (
              <p className="mt-1 text-xs text-red-400">{errors.changeReason}</p>
            )}
