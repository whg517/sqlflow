...
vi.mock('@/components/ui/select', () => ({
  Select: ({ children, value, onValueChange }: { children: React.ReactNode; value: string; onValueChange: (v: string) => void }) => {
    ;(globalThis as Record<string, unknown>).__userSelectOnValueChange = onValueChange
  ...
  SelectItem: ({ children, value }: { children: React.ReactNode; value: string }) =>
    <div data-testid="select-item" data-value={value} onClick={() => {
      const cb = (globalThis as Record<string, unknown>).__userSelectOnValueChange as ((v: string) => void) | undefined
      cb?.(value)
    }}>{children}</div>,
}))
...
const mockUsers = {
  users: [
    { id: 1, username: 'admin', role: 'admin', status: 'active', created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
    { id: 2, username: 'dba_user', role: 'dba', status: 'active', created_at: '2026-02-01T00:00:00Z', updated_at: '2026-02-01T00:00:00Z' },
    { id: 3, username: 'dev_user', role: 'developer', status: 'active', created_at: '2026-03-01T00:00:00Z', updated_at: '2026-03-01T00:00:00Z' },
  ],
  total: 3,
}
