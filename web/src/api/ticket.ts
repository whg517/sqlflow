...
export async function createTicket(req: CreateTicketRequest): Promise<CreateTicketResponse> {
  return api.post<CreateTicketResponse>('/tickets', req)
}

export async function approveTicket(id: number, comment: string): Promise<TicketActionResponse> {
  return api.post<TicketActionResponse>(`/tickets/${id}/approve`, { comment })
}

export async function rejectTicket(id: number, reason: string): Promise<TicketActionResponse> {
  return api.post<TicketActionResponse>(`/tickets/${id}/reject`, { reason })
}

export async function cancelTicket(id: number, reason: string): Promise<TicketActionResponse> {
