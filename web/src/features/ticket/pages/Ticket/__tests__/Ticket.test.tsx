...
vi.mock("@/features/ticket/pages/Ticket/components/TicketDetailDrawer", () => ({
  default: ({
    open,
    ticketId,
  }: {
    ...
    open ? (
      <div data-testid="ticket-detail-drawer">Ticket #{ticketId}</div>
    ) : null,
}));
...
describe("TicketPage", () => {
  ...
  describe("rendering", () => {
    ...
    it("renders search input", () => {
      renderTicketPage();
      expect(
        screen.getByPlaceholderText("搜索 SQL 内容..."),
      ).toBeInTheDocument();
    });
  });
