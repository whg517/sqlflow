...
vi.mock("@/features/ticket/api/ticket", () => ({
...
vi.mock("@/features/ticket/api/approval", () => ({
  getApprovalHistory: (...args: unknown[]) => mockGetApprovalHistory(...args),
}));

// Mock ApprovalStepper
vi.mock("@/features/ticket/pages/Ticket/components/ApprovalStepper", () => ({
...
// Mock CommentSection
vi.mock("@/features/ticket/pages/Ticket/components/CommentSection", () => ({
...
import TicketDetailDrawer from "@/features/ticket/pages/Ticket/components/TicketDetailDrawer";
