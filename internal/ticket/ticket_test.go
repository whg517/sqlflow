...
func TestFullWorkflow(t *testing.T) {
	// Exercises the full SUBMITTED → PENDING_APPROVAL → APPROVED → EXECUTING →
	// DONE lifecycle without a live MySQL, by injecting a sqlmock-backed driver
	// into the pool that executeSQL resolves against.
	testDB := setupTicketTestDB(t)
