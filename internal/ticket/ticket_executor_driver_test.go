...
func (m *testExecDriver) ConfigSchema() []driver.ConfigField                    { return nil }
func (m *testExecDriver) Connect(ctx context.Context, cfg *driver.Config) error { return nil }
func (m *testExecDriver) Close() error                                          { return nil }
...
func (m *testExecDriver) ListTables(ctx context.Context, db string) ([]driver.TableInfo, error) {
	return nil, nil
}
...
func TestExecuteSQL_DriverPath_MySQL(t *testing.T) {
	...
	results, err := svc.executeSQL(context.Background(), ds, ds.Type, "testdb", "CREATE TABLE t1 (id INT); INSERT INTO t1 VALUES (1)")
	if err != nil {
...
func TestExecuteSQL_DriverPath_PostgreSQLRollback(t *testing.T) {
	...
	results, err := svc.executeSQL(context.Background(), ds, ds.Type, "testdb", "CREATE TABLE t1 (id INT); INSERT INTO no_such_table VALUES (1)")
	if err == nil {
