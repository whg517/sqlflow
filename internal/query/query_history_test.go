...
func TestQueryHistoryService_CreateAndList(t *testing.T) {
	...
	userID := testutil.SeedUser(t, testDB, "qh_user", "developer")
	dsID := testutil.SeedDatasource(t, testDB, "qh-ds")
	...
	t.Run("list_empty_for_other_user", func(t *testing.T) {
		otherID := testutil.SeedUser(t, testDB, "qh_other", "developer")
...
func TestQueryHistoryService_DeleteHistory(t *testing.T) {
	...
	userID := testutil.SeedUser(t, testDB, "qh_del_user", "developer")
	dsID := testutil.SeedDatasource(t, testDB, "qh-del-ds")
	...
	t.Run("delete_other_user_record_fails", func(t *testing.T) {
		otherID := testutil.SeedUser(t, testDB, "qh_del_other", "developer")
...
func TestQueryHistoryService_ClearHistory(t *testing.T) {
	...
	userID := testutil.SeedUser(t, testDB, "qh_clear_user", "developer")
	dsID := testutil.SeedDatasource(t, testDB, "qh-clear-ds")
	...
	t.Run("clear_does_not_affect_other_users", func(t *testing.T) {
		otherID := testutil.SeedUser(t, testDB, "qh_clear_other", "developer")
		for i := 0; i < 2; i++ {
			h := &model.QueryHistory{
...
func TestQueryHistoryService_CreateHistoryWithZeroValues(t *testing.T) {
	...
	userID := testutil.SeedUser(t, testDB, "qh_zero_user", "developer")
	dsID := testutil.SeedDatasource(t, testDB, "qh-zero-ds")
