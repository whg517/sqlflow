...
func TestPerformanceService_ListSlowQueries(t *testing.T) {
	...
	userID := testutil.SeedUser(t, testDB, "perf_user", "developer")
	dsID := testutil.SeedDatasource(t, testDB, "perf-ds")
...
func TestPerformanceService_GetPerformanceStats(t *testing.T) {
	...
	userID := testutil.SeedUser(t, testDB, "perf_stats_user", "developer")
	dsID := testutil.SeedDatasource(t, testDB, "perf-stats-ds")
