...
func setupQueryService(t *testing.T) (*Service, *sql.DB) {
	...
	dsSvc := datasource.NewService(testutil.WrapSQL(t, testDB), testutil.EncryptionKey, connMgr, nil)
...
func TestExecuteQuery_DisabledDataSource(t *testing.T) {
	...
	dsSvc := datasource.NewService(testutil.WrapSQL(t, testDB), testutil.EncryptionKey, connpool.NewManager(), nil)
