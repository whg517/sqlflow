...
func TestGitService_CreateAndList(t *testing.T) {
	...
	gitSvc := NewGitService(testutil.WrapSQL(t, db))

	ctx := context.Background()

	// Create a test user for created_by
	userID := testutil.CreateUser(t, db, "git_tester")
...
func TestGitService_PRCreation(t *testing.T) {
	...
	ctx := context.Background()
	userID := testutil.CreateUser(t, db, "git_pr_tester")
...
func TestGitService_Delete(t *testing.T) {
	...
	ctx := context.Background()
	userID := testutil.CreateUser(t, db, "git_delete_tester")
...
func TestGitService_ValidationErrors(t *testing.T) {
	...
	gitSvc := NewGitService(testutil.WrapSQL(t, db))
	ctx := context.Background()
	userID := testutil.CreateUser(t, db, "git_valid_tester")
...
func TestGitService_GetByID(t *testing.T) {
	...
	ctx := context.Background()
	userID := testutil.CreateUser(t, db, "git_get_tester")
...
func TestGitService_PopulateGitLinks(t *testing.T) {
	...
	ctx := context.Background()
	userID := testutil.CreateUser(t, db, "git_populate_tester")
