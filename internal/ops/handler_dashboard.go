...
func NewDashboardHandler(dashboardSvc *DashboardService) *DashboardHandler {
...
// @Produce json
// @Security BearerAuth
// @Success 200 {object} resp.SuccessResponse{data=DashboardStats} "成功"
...
// @Security BearerAuth
// @Success 200 {object} resp.SuccessResponse{data=DashboardFullStats} "成功"
