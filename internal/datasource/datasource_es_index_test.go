...
// setupESDatasourceTest creates a Service with an injected ES client pointing to a test server.
func setupESDatasourceTest(t *testing.T, handler http.HandlerFunc) (*Service, int64) {
	t.Helper()
