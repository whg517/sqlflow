...
func (_q *ApprovalRecordQuery) Modify(modifiers ...func(s *sql.Selector)) *ApprovalRecordSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *ApprovalRecordSelect) Modify(modifiers ...func(s *sql.Selector)) *ApprovalRecordSelect {
