...
type User struct {
	...
	// DingtalkUserID holds the value of the "dingtalk_user_id" field.
	DingtalkUserID string `json:"dingtalk_user_id,omitempty"`
	// DingtalkUnionID holds the value of the "dingtalk_union_id" field.
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldUsername, user.FieldPasswordHash, user.FieldRole, user.FieldDingtalkUserID, user.FieldDingtalkUnionID, user.FieldOidcSubject, user.FieldOidcProvider:
			values[i] = new(sql.NullString)
		case user.FieldCreatedAt, user.FieldUpdatedAt, user.FieldPasswordChangedAt:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldDingtalkUserID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field dingtalk_user_id", values[i])
			} else if value.Valid {
				_m.DingtalkUserID = value.String
			}
		case user.FieldDingtalkUnionID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field dingtalk_union_id", values[i])
			} else if value.Valid {
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("dingtalk_user_id=")
	builder.WriteString(_m.DingtalkUserID)
	builder.WriteString(", ")
	builder.WriteString("dingtalk_union_id=")
	builder.WriteString(_m.DingtalkUnionID)
	builder.WriteString(", ")
