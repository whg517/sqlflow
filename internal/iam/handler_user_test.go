...
// createAuthedUser creates a user through the auth service and returns the
// claims of a real token for it — distinct from testutil.CreateUser, which only
// inserts a row and cannot produce a token.
func createAuthedUser(t *testing.T, authSvc *Service, username, password, role string) *Claims {
	t.Helper()
...
func setAuthContext(c echo.Context, claims *Claims) {
...
func TestUserHandler_Me(t *testing.T) {
	e, authSvc, h := setupUserTest(t)
	claims := createAuthedUser(t, authSvc, "meuser", "Password123", "dba")
...
func TestUserHandler_Me_UserNotFound(t *testing.T) {
	...
	claims := createAuthedUser(t, authSvc, "ghost", "Password123", "developer")
	ctx := testutil.ContextWithTimeout(t)
...
func TestUserHandler_ChangePassword(t *testing.T) {
	e, authSvc, h := setupUserTest(t)
	claims := createAuthedUser(t, authSvc, "changepw", "OldPassword1", "developer")
...
func TestUserHandler_UpdateUser(t *testing.T) {
	...
	adminClaims := createAuthedUser(t, authSvc, "admin_user", "Password123", "admin")
...
func TestUserHandler_DeleteUser(t *testing.T) {
	...
	adminClaims := createAuthedUser(t, authSvc, "deladmin", "Password123", "admin")
...
func TestUserHandler_Refresh_Success(t *testing.T) {
	...
	createAuthedUser(t, authSvc, "refreshtest", "password123", "developer")
