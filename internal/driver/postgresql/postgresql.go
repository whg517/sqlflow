...
func (d *PostgreSQLDriver) executeQuery(ctx context.Context, query string, args []interface{}, limit int) (*driver.QueryResult, error) {
	return sqlrows.Query(ctx, d.db, "postgresql", query, args, limit)
}
