...
func (h *SettingsHandler) UpdateNotifyConfig(c echo.Context) error {
...
func (h *SettingsHandler) TestNotify(c echo.Context) error {
...
func (h *SettingsHandler) UpdateAIConfig(c echo.Context) error {
...
func (h *SettingsHandler) UpdateFeishuConfig(c echo.Context) error {
...
func (h *SettingsHandler) TestFeishuNotify(c echo.Context) error {
