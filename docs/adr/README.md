...
| [0003](0003-capability-based-datasource-drivers.md) | 使用能力声明的数据源驱动抽象 | **superseded**（由 0011 取代） | 2026-07-14（补录） |
...
| [0011](0011-optional-interfaces-as-driver-capabilities.md) | 驱动能力由可选接口表达，不再显式声明 | accepted | 2026-08-08 |
